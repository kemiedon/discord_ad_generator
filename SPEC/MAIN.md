...
- 更新圖片風格選項為 4 種:
  ...
  - Pixel遊戲 (Pixel Game) - 8位元復古遊戲風格
  - 高寫實照片 (Photorealistic) - 超高清專業攝影
  - 復古海報 (Retro Poster) - 1960-1980年代復古設計
...
- 下拉選單，包含以下預設風格選項：
  ...
  2. ✅ Pixel遊戲 (Pixel Game) - 8位元復古遊戲美學、像素化圖形
  3. ✅ 高寫實照片 (Photorealistic) - 超高清8K解析度、專業攝影、電影級打光
  4. ✅ 復古海報 (Retro Poster) - 1960-1980年代風格、粗體字、扁平設計
- 使用者可選擇其中一種風格
